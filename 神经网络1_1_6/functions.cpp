...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "D:\\大三上资料\\数字图像处理\\C++_Project\\神经网络_1_6\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\大三上资料\\数字图像处理\\C++_Project\\神经网络_1_6\\yolov3.cfg";
	//权重
	String weights = "D:\\大三上资料\\数字图像处理\\C++_Project\\神经网络_1_6\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\大三上资料\\数字图像处理\\C++_Project\\神经网络_1_6\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\大三上资料\\数字图像处理\\C++_Project\\神经网络_1_6\\pose_iter_440000.caffemodel";
	...
	while (1) {
		...
		//cv::Mat frame = imread("C:\\Users\\Lenovo\\Downloads\\测试图.JPEG");
		cv::Mat frame;
